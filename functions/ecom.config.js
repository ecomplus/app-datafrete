  ...
  admin_settings: {
    ...
    datafrete_token: {
      schema: {
        ...
        description: 'Solitite no Datafrete o token para REST API cálculo frete'
      },
      hide: true
    },
    datafrete_doc: {
      schema: {
        ...
        description: 'Número do documento associado à sua conta Datafrete'
      },
      hide: true
    },
    datafrete_endpoint: {
      schema: {
        type: 'string',
        maxLength: 255,
        title: 'Datafrete API endpoint',
        default: 'https://apresentacao.api.dev.datafreteapi.com'
      },
      hide: true
    },
    free_shipping_rules: {
      schema: {
        ...
        description: 'Deve ser configurado em conformidade às tabelas na sua conta Datafrete',
        type: 'array',
        maxItems: 300,
        items: {
